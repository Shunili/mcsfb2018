function [filter_bank, band_ends, shifted_ends] = mcsfb_design_filter_bank_v2(G, num_bands,param)
...
% to split on three switch
if gsp_check_fourier(G) %minima of cdf
    %if param.spacing = 'logarithm', four cases
    for k = 2:num_bands
        idx = G.N*(1/2)^k;
