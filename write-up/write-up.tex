...
\begin{figure}[h]
\centering
\includegraphics[width = 7 cm]{signal graph mn.pdf}
\includegraphics[width = 7 cm]{filter mn.pdf}

\includegraphics[width = 7 cm]{sampling weights.pdf}
\includegraphics[width = 7 cm]{selected.pdf}
\end{figure}
